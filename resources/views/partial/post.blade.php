          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('post.create') }}">Forms</a></li>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group mt-5">
                        ...
                        <input type="text" class="form-control" id="post_name" placeholder="Enter your Post Name" name="post_name">
                      </div>
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                ...
                                @foreach($categories as $category)
                                    <input class="m-2" type="checkbox" name="category_id[]" class="form-control" value="{{ $category->id }}">{{$category->category_name}}
                                @endforeach
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="desc" placeholder="Type here..." name="desc">
                      </div>
